...
entity streaming_attention_control_s_axi is
generic (
...
end entity streaming_attention_control_s_axi;
...
architecture behave of streaming_attention_control_s_axi is
    ...
    constant ADDR_Q_DATA_0 : INTEGER := 16#10#;
    constant ADDR_Q_DATA_1 : INTEGER := 16#14#;
    constant ADDR_Q_CTRL   : INTEGER := 16#18#;
    constant ADDR_K_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_K_DATA_1 : INTEGER := 16#20#;
    constant ADDR_K_CTRL   : INTEGER := 16#24#;
    constant ADDR_V_DATA_0 : INTEGER := 16#28#;
    constant ADDR_V_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_V_CTRL   : INTEGER := 16#30#;
    constant ADDR_O_DATA_0 : INTEGER := 16#34#;
    constant ADDR_O_DATA_1 : INTEGER := 16#38#;
    constant ADDR_O_CTRL   : INTEGER := 16#3c#;
